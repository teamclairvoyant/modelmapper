 ...
 *
 * @see org.clairvoyant.modelmapper.Converter
 */
public class Converters {
  ...
  public interface ChainableConverter<S, D1> {
     ...
     * @return a converter
     */
    <D2> org.clairvoyant.modelmapper.Converter<S, D2> to(Class<D2> destinationType);
     ...
     * @return a converter
     */
    <D2> org.clairvoyant.modelmapper.Converter<S, D2> map(org.clairvoyant.modelmapper.Converter<D1, D2> converter);
  }
  ...
  public static class Collection {
     ...
     * @return a Converter
     */
    public static <S, D> org.clairvoyant.modelmapper.Converter<java.util.Collection<S>, java.util.Collection<D>> map(final Converter<S, D> elementConverter) {
      return new org.clairvoyant.modelmapper.Converter<java.util.Collection<S>, java.util.Collection<D>>() {
        @Override
    ...
    public static <S> ChainableConverter<java.util.Collection<S>, S> first() {
      return new ChainableConverter<java.util.Collection<S>, S>() {
        @Override
        public <D> org.clairvoyant.modelmapper.Converter<java.util.Collection<S>, D> to(Class<D> destinationType) {
          return new org.clairvoyant.modelmapper.Converter<java.util.Collection<S>, D>() {
            @Override
        ...
        @Override
        public <D> org.clairvoyant.modelmapper.Converter<java.util.Collection<S>, D> map(
            final org.clairvoyant.modelmapper.Converter<S, D> converter) {
          return new org.clairvoyant.modelmapper.Converter<java.util.Collection<S>, D>() {
            @Override
            public D convert(MappingContext<java.util.Collection<S>, D> context) {
              if (context.getSource() == null || context.getSource().isEmpty())
